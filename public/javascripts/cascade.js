...
function createQuestionare(ctrl){
    ...
    divScroller.style.height = "calc(100vh - 150px)";
        ...
        if($(ctrls_collection[i]) && $(ctrl_value_assoc[ctrls_collection[i]])){
            if($(ctrls_collection[i]).type == "textbox"){
                ...
                if($(ctrls_collection[i]).checked){
                    ...
                    if($(ctrl_value_assoc[ctrls_collection[i]])) $(ctrl_value_assoc[ctrls_collection[i]]).removeAttribute("disabled");

                } else {

                    if($(ctrl_value_assoc[ctrls_collection[i]])) $(ctrl_value_assoc[ctrls_collection[i]]).setAttribute("disabled", true);
