...
(function () {
    ...
    function queryEncounter(encounter, id, callback) {
        ...
        if (window.parent.dashboard) {
            ...
            result = window.parent.dashboard.getAnyExistingEncounters("DIABETES PROGRAM", encounter);
        ...
        if (__$__("details")) {
           ...
           var colors = [
            ...
            img.onclick = function () {
                ...
                window.parent.dashboard.navPanel('/spec/dm/diabetes_history.spec')

            }

            if (!window.parent.dashboard.queryAnyExistingEncounters("DIABETES PROGRAM", "DIABETES HISTORY")) {
            ...
            queryEncounter("DIABETES HISTORY", "divDiabetesHistory", function (data, id) {
            ...
            img.onclick = function () {
                ...
                window.parent.dashboard.navPanel('/spec/dm/past_medical_history.spec')

            }

            if (!window.parent.dashboard.queryAnyExistingEncounters("DIABETES PROGRAM", "PAST DIABETES MEDICAL HISTORY")) {
            ...
            img.onclick = function () {
                ...
                window.parent.dashboard.navPanel('/spec/dm/general_health.spec')

            }

            if (!window.parent.dashboard.queryAnyExistingEncounters("DIABETES PROGRAM", "GENERAL HEALTH")) {
            ...
            var div = document.createElement("div");
            div.id = "divGeneralHealth";
            div.style.border = "1px solid " + colors[4][0];
            div.style.minHeight = "30px";
            div.style.backgroundColor = colors[0][2];
            div.innerHTML = "&nbsp;";

            td.appendChild(div);

            queryEncounter("GENERAL HEALTH", "divGeneralHealth", function (data, id) {
            ...
            div.style.border = "1px solid " + colors[5][0];
            div.style.minHeight = "30px";
            div.style.backgroundColor = colors[0][2];
            div.innerHTML = "&nbsp;";
    ...
    if(dashboard.autoContinue){
            ...
            if(dashboard.medicalHistoryWorkflow.length == 0){
                ...
                var nextworkflow = window.parent.dashboard.workflow[0];

                dashboard.$(nextworkflow).click();
    ...
    dashboard.subscription.addEventlistener("done", function(){
        ...
        if(dashboard.activeTask == "Patient History") {
