...
if (Object.getOwnPropertyNames(Date.prototype).indexOf("format") < 0) {
    ...
    function loadPage(id,tdElement) {
    ...
    if (id == "creatinine") {
        ...
        if(window.parent.dashboard.queryActiveObs("DIABETES PROGRAM",visit_today,"DIABETES TEST","Creatinine Result")===undefined){
            ...
            img.onclick = function(){
                ...
                window.parent.dashboard.exitNavPanel('/spec/dm/creatinine.spec');
    ...
    if (id =="urine_protein") {
        ...
        if(window.parent.dashboard.queryActiveObs("DIABETES PROGRAM",visit_today,"DIABETES TEST","Urine Protein Result")===undefined){
    ...
    if (id == "visual_acuity") {
        ...
        if(window.parent.dashboard.queryActiveObs("DIABETES PROGRAM",visit_today,"DIABETES TEST","Visual Acuity Result Test Date")===undefined){
            ...
            img.onclick = function(){
                ...
                window.parent.dashboard.exitNavPanel('/spec/dm/visual_acuity.spec')
    ...
    if (id == "fundoscopy"){
        ...
        if(window.parent.dashboard.queryActiveObs("DIABETES PROGRAM",visit_today,"DIABETES TEST","Fundoscopy Result Test Date")===undefined){
            ...
            img.onclick = function(){
                ...
                window.parent.dashboard.exitNavPanel('/spec/dm/fundoscopy.spec')
    ...
    if (id =="foot_check"){
        ...
        if(window.parent.dashboard.queryActiveObs("DIABETES PROGRAM",visit_today,"DIABETES TEST","Foot Check Result Test Date")===undefined){
            ...
            img.onclick = function(){
                ...
                window.parent.dashboard.exitNavPanel('/spec/dm/foot_check.spec')
    ...
    if (id == "urea") {
        ...
        __$("complication_name").innerHTML = "Urea"

        if(window.parent.dashboard.queryActiveObs("DIABETES PROGRAM",visit_today,"DIABETES TEST","Urea Result Test Date")===undefined){
            ...
            img.onclick = function(){
                ...
                window.parent.dashboard.exitNavPanel('/spec/dm/urea.spec')
    ...
    if (id == "macrovascular"){
        ...
        if(window.parent.dashboard.queryActiveObs("DIABETES PROGRAM",visit_today,"DIABETES TEST","Macrovascular Result Test Date")===undefined){
            ...
            img.onclick = function(){
                ...
                window.parent.dashboard.exitNavPanel('/spec/dm/macrovascular.spec')
    ...
    var height = (0.64 * windowHeight);

    var containt_height = __$("complication_data").clientHeight;

   // __$("complication_data").style.overflowY = "scroll";

    if(containt_height > height){

            __$("complication_data").style.height = (parseInt(height)-100)+"px";

            __$("complication_data").style.overflowY = "auto";
    }
 ...
 var tasks = {
                        ...
                        "urine_protein"    :  ["Urine Protein Result" , "/spec/dm/urine_protein.spec"],
                        "visual_acuity"    :  ["Visual Acuity Result Test Date" ,"/spec/dm/visual_acuity.spec"],
                        "fundoscopy"       :  ["Fundoscopy Result Test Date" ,"/spec/dm/fundoscopy.spec"],
                        "foot_check"       :  ["Foot Check Result Test Date" ,"/spec/dm/foot_check.spec"],
                        "urea"             :  ["Urea Result Test Date","/spec/dm/urea.spec"],
                        "macrovascular"    :  ["Macrovascular Result Test Date" ,"/spec/dm/macrovascular.spec"]
...
function executeAutoConitnue(){
    ...
    for(var h = 0 ;h < tasks_keys.length; h++){
        ...
        if(window.parent.dashboard.queryActiveObs("DIABETES PROGRAM",visit_today,"DIABETES TEST",tasks[tasks_keys[h]][0])){
    ...
    if(dashboard.complicationWorkFlow && dashboard.complicationWorkFlow.length > 0){
        ...
        for(var i = 0 ; i < dashboard.complicationWorkFlow.length; i++){
            ...
            if(window.parent.dashboard.queryActiveObs("DIABETES PROGRAM",visit_today,"DIABETES TEST",tasks[dashboard.complicationWorkFlow[i]][0].trim())===undefined){
