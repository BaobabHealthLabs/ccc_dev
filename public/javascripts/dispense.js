...
function generateGenerics(patient_id){
    ...
    parent_container.style.marginTop = "0px";
    ...
    doseDiv.style.height = "calc(100vh - 465px)";
    ...
    doseListDiv.style.height = "calc(100vh - 520px)";
    // doseListDiv.style.border = "solid 1px #000";
    ...
    drugsListDiv.style.height = "calc(100vh - 270px)";
...
function removeGenerics(){    
    ...
    for(var i = 0; i <  __$("ulDoses").children.length; i++){        
        for(var j = 0; j < fields.length; j++){            
            ...
            field.type = "hidden";
            field.name = "data.prescriptions[" + i + "]." + fields[j];
