    ...
    function loadPage() {
        ...
        if (__$__("details")) {
           ...
           var colors = [
            ...
            queryEncounter("EPILEPSY INITIAL QUESTIONS", "divInitialQuestions", function (data, id) {
            ...
            td.style.padding = "8px";
            td.style.fontSize = "18px";
            td.innerHTML = "Patient Histroy at Enrolment";
            ...
            img.onclick = function () {
                ...
                window.parent.dashboard.navPanel('/spec/epilepsy/enrolment_history.spec')

            }

            if (!window.parent.dashboard.queryAnyExistingEncounters("EPILEPSY PROGRAM", "PATIENT HISTORY AT ENROLMENT")) {
            ...
            queryEncounter("PATIENT HISTORY AT ENROLMENT", "divEnrolmentHistory", function (data, id) {
            ...
            img.onclick = function () {
                ...
                window.parent.dashboard.navPanel('/spec/epilepsy/medical_history.spec')

            }

            if (!window.parent.dashboard.queryAnyExistingEncounters("EPILEPSY PROGRAM", "MEDICAL AND SURGICAL HISTORY")) {
            ...
            queryEncounter("MEDICAL AND SURGICAL HISTORY", "divPastMedicalHistory", function (data, id) {
            ...
            img.onclick = function () {
                ...
                window.parent.dashboard.navPanel('/spec/epilepsy/family_history.spec')

            }

            if (!window.parent.dashboard.queryAnyExistingEncounters("EPILEPSY PROGRAM", "FAMILY HISTORY")) {
