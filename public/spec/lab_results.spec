...
Q.1.1. Select the type of test taken: [pos :: 0 $$ id :: test_types $$ multiple :: multiple $$ tt_pageStyleClass :: MultiSelectList $$ optional :: true $$ concept :: Blood Sugar Test Type]
