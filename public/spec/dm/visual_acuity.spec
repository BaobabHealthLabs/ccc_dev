...
Q.1.1. Diabetes Test Type [pos:: 0$$ value:: Visual Acuity$$ condition:: false]
...
Q.1.3. Visual Acuity Result Test Date [pos:: 2$$ field_type:: birthdate$$ estimate_label:: Year(s) ago]