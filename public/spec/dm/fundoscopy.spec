...
Q.1.3. Fundoscopy Result Test Date [pos :: 2$$ field_type :: date $$ estimate_label :: Year(s) ago $$ parent :: Diabetes Test Type:Fundoscopy $$tt_onUnLoad::validateWithBirthDate()]
