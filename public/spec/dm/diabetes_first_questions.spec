...
Q.1.2. Diabetes Transfer-In Date [pos:: 1$$ id:: transfer_in_date$$ field_type:: date$$ condition:: !existingDiabetesPatient()$$ estimate_label:: Number of years ago $$ parent :: TYPE OF PATIENT]
