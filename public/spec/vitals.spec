...
Q.1.1. Temperature (<sup>o</sup>C) [pos:: 0$$ concept:: Temperature (C)$$ condition:: window.parent.dashboard.modules[window.parent.dashboard.getCookie("currentProgram")].vitals && window.parent.dashboard.modules[window.parent.dashboard.getCookie("currentProgram")].vitals.ask_temperature$$ field_type:: number$$ min:: 20$$ max:: 45$$ optional:: true$$ validationRule:: ([0-9]+(\\.)*[0-9]*)|Unknown$ $$ validationMessage:: You must enter a decimal between 0 and 9 (for example: 36<b>.6</b>) $$ tt_pageStyleClass:: Numeric NumbersOnlyWithDecimal]
