...
Q.1.7.4.1. TB Contact Date [pos::9$$field_type::date$$ id::tb_contact_date$$parent::Patient History and Exposures:Indoor cooking $$tt_onUnLoad::validateWithBirthDate()]

Q.1.7.5.1. Smoking Date [pos:: 10$$field_type::date$$ id:: smoking_date$$parent::Patient History and Exposures:Smoking $$tt_onUnLoad::validateWithBirthDate()]

Q.1.7.6.1. Secondhand smocking Date [pos:: 11$$field_type::date$$ id::secondhand_smoking_date$$parent::Patient History and Exposures:Secondhand smoking $$tt_onUnLoad::validateWithBirthDate()]
...
Q.1.7.3.2. Occupation Exposure Date[pos:: 13$$field_type::date$$id::occupational_exposure1$$parent::Patient History and Exposures:Occupational Exposure $$tt_onUnLoad::validateWithBirthDate()]

Q.1.8. Summary [pos :: 3 $$ id:: summary $$ tt_onLoad::loadSummary() $$ tt_pageStyleClass::NoControls $$ helpText::Patient Overview Summary $$condition::true]
