...
Q.1.1.2.2. Transfer-In Date [pos:: 2$$concept::Asthma Transfer-In Date$$ id:: transfer_in_date$$ field_type:: date$$ condition:: !existingPatient()&&__$("patient_type").value !="New Patient"$$ estimate_label:: Number of years ago $$ parent :: TYPE OF PATIENT]

Q.1.3. Asthma Diagnosis Date [pos:: 3$$ id:: initial_diagnosis_date$$ field_type:: date$$ condition::!existingPatient()$$ estimate_label:: Number of years ago $$ parent :: TYPE OF PATIENT$$tt_onUnLoad::diagonosidAndTransfer();validateWithBirthDate()]
