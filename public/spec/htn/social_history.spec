...
Q.1.3. 	Number of cigarette per day? [pos::2$$condition::__$("smoke").value == "Yes"$$parent::Do you currently smoke?$$field_type::number$$tt_pageStyleClass :: Numeric NumbersOnlyWithDecimal$$min::0max::100]
