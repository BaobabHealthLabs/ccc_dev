...
Q.1.3. Macrovascular Result Test Date [pos:: 2$$ field_type:: date $$ estimate_label:: Year(s) ago $$ parent :: Hypertension Test Type:Macrovascular validateWithBirthDate()]

C.1.4. Summary [pos :: 3 $$ id:: summary $$ tt_onLoad::loadSummary() $$ tt_pageStyleClass::NoControls $$ helpText::Macrovascular Test Summary $$condition::true]