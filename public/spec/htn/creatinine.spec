...
Q.1.3. Creatinine Test Date [pos :: 4 $$ field_type:: date $$ estimate_label :: Year(s) ago $$ parent :: Hypertension Test Type:Creatinine validateWithBirthDate()]

C.1.4. Summary [pos :: 5 $$ id:: summary $$ tt_onLoad::loadSummary() $$ tt_pageStyleClass::NoControls $$ helpText::Creatinine Test Summary $$condition::true]
