...
Q.1.3. Epilepsy Diagnosis Date [pos:: 3$$ id:: initial_diagnosis_date$$ field_type:: date$$ estimate_label:: Number of years ago$$condition:: !existingPatient()$$parent ::TYPE OF PATIENT$$tt_onUnLoad::diagonosidAndTransfer();validateWithBirthDate()]

Q.1.4. Summary [pos :: 4 $$ id:: summary $$ tt_onLoad::loadSummary() $$ tt_pageStyleClass::NoControls $$ helpText::Initial Questions Summary $$condition::true]