...
Q.1.2. Generalized Epilepsy [pos::1$$allowFreeText:: false$$condition::__$('epilepsy_category').value=="Generalized Epilepsy"]
...
Q.1.3. Partial Epilepsy [pos:: 2$$allowFreeText:: false$$condition::__$('epilepsy_category').value=="Partial Epilepsy"]
O.1.3.1. Simple
O.1.3.2. Complex
O.1.3.3. Unclassfied
