...
var dashboard = ({
    ...
    addRelationship: function () {
        ...
        var fields = {
            ...
            "First Name": {
                ...
                allowFreeText: true,
                id: "data.first_name",
                ajaxURL: dashboard.settings.firstNamesPath
            },
            "Last Name": {
                field_type: "text",
                allowFreeText: true,
                id: "data.last_name",
                ajaxURL: dashboard.settings.lastNamesPath
            },
            "Gender": {
                field_type: "select",
                id: "data.gender",
            ...
            "Select or Create New Person": {
                ...
                tt_onLoad: "window.parent.dashboard.loadNames();",
                tt_pageStyleClass: "NoControls NoKeyboard",
                tt_onUnload: "__$('nextButton').className = __$('nextButton').className.replace(/gray/i, 'green'); " +
                    "__$('nextButton').onmousedown=function(){if(this.className.match(/gray/)) return; gotoNextPage()}; " +
                    "if(__$('btnNew')) __$('extras').removeChild(__$('btnNew'));"
            },
            "Person": {
                field_type: "hidden",
                id: "data.person_id",
    ...
    loadNames: function () {
        ...
        btnNew.onmousedown = function () {
            ...
            window.parent.dashboard.$$("selected_patient").value = "";

            window.parent.dashboard.__().submitData();
    ...
    ajaxSearch: function (page) {
        ...
        var url = window.parent.dashboard.settings.searchPath + "/?first_name=" + window.parent.dashboard.$$("data.first_name").value.trim() +
    ...
    handleAjaxRequest: function (aXMLHttpRequest) {
        ...
        if (aXMLHttpRequest.readyState == 4 && aXMLHttpRequest.status == 200) {
            ...
            if (Object.keys(window.parent.dashboard.patients).length == 0) {
                window.parent.dashboard.$$("rightpanel").innerHTML = "<div style='margin: auto; padding: 20px; font-size: 24px; font-style: italic;'>No results found!</div>";
            }
                ...
                div.onclick = function () {
                    ...
                    if (window.parent.dashboard.$$('nextButton')) {
                        ...
                        window.parent.dashboard.$$('nextButton').onmousedown = function () {
                            ...
                            // window.location = window.parent.dashboard.settings.basePath + "/patient/" + window.parent.dashboard.$$("selected_patient").value.trim();
    ...
    showPatient: function (pos) {
        ...
        cell2_2.innerHTML = (window.parent.dashboard.patients[pos]["birthdate_estimated"] ? "~" : "") + window.parent.dashboard.patients[pos]["age"];
    ...
    init: function (dataPath, modulesPath, settingsPath) {
        ...
        dashboard.setCookie("patient_id", window.location.href.match(/\/([^\/]+)$/)[1], 0.33333);
