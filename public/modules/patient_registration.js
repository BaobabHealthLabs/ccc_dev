...
var patient = ({
    ...
    submitRawData: function (data) {
        ...
        patient.ajaxPostRequest(patient.settings.demographicsUpdatePath, data, function (result) {
    ...
    ajaxSearch: function (page) {
        ...
        var url = patient.settings.searchPath + "/?first_name=" + patient.$("first_name").value.trim() +
    ...
    loadNames: function () {
        ...
        navUp.onmousedown = function () {
            ...
            patient.ajaxSearch(patient.page);
        }
                ...
                for (var j = 0; j < 4; j++) {
                    ...
                    switch (j) {
                        ...
                        case 2:
                            ...
                            var url = patient.settings.demographicsQueryPath + field + "&person_id=" + patient_id +
                                "&token=" + patient.getCookie("token");

                            patient.ajaxRequest(url, function (result) {
            ...
            if (patient.settings.demographics[fields[i]] || ["Current Region", "Region of Origin"].indexOf(fields[i]) >= 0) {
                ...
                switch (fields[i]) {
                    ...
                    case "Current District":
                        ...
                        input['ajaxURL'] = patient.settings.districtQueryPath + "?region=&district=";
                    ...
                    case "Current T/A":
                        ...
                        input['ajaxURL'] = patient.settings.taQueryPath + "?district=&ta=";
                    ...
                    case "Current Village":
                        ...
                        input['ajaxURL'] = patient.settings.villageQueryPath + "?district=&ta=&village=";
                    ...
                    case "Nationality":
                        ...
                        input['ajaxURL'] = patient.settings.nationalityQueryPath;
                    ...
                    case "Occupation":
                        ...
                        input['ajaxURL'] = patient.settings.occupationsQueryPath;
                    ...
                    case "Middle Name":
                        ...
                        input['ajaxURL'] = patient.settings.firstNamesPath + "?name=";
                    ...
                    case "Last Name":
                        ...
                        input['ajaxURL'] = patient.settings.lastNamesPath + "?name=";
            ...
            if (patient.settings.demographics[fields[i]] || ["Current Region", "Region of Origin",
                ...
                switch (fields[i]) {
                    ...
                    case "Last Name":
                        ...
                        input.setAttribute("ajaxURL", patient.settings.lastNamesPath + "?name=");
    ...
    buildAddPage: function (first_name, last_name, gender) {
        ...
        form.id = "patient.form.main";
        form.style.display = "none";
        form.setAttribute("action", "javascript:patient.submitData('" + patient.settings.savePath + "')");
            ...
            if (patient.settings.demographics[fields[i]] || ["Current Region", "Region of Origin"].indexOf(fields[i]) >= 0) {
                ...
                switch (fields[i]) {
                    ...
                    case "Current District":
                        ...
                        input.setAttribute("ajaxURL", patient.settings.districtQueryPath + "?region=&district=");
                    ...
                    case "Current T/A":
                        ...
                        input.setAttribute("ajaxURL", patient.settings.taQueryPath + "?district=&ta=");
                    ...
                    case "Nationality":
                        ...
                        input.setAttribute("ajaxURL", patient.settings.nationalityQueryPath + "?nationality=");
